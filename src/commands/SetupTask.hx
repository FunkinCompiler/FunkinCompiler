...
class SetupTask {
	...
	public static function task_setupEnvironment(template_url:String) {
		...
		runSetupCommand("haxelib git funkin https://github.com/FunkinCompiler/Funkin-lib.git b1ce3a23cd196e126a0a6fcae9e501c5b3780ad2 --always");
